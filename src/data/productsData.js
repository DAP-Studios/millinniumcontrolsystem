...
export const initialCategories = [
  ...
  },
  {
    ...
    "name": "Modular I/O Systems",
    "description": "NZ2 series remote I/O stations and slice-type terminals for distributed field wiring over CC-Link IE TSN and CC-Link IE Field networks.",
    "image": "/images/products/modular-io-systems_nz2-slice-terminal.jpg"
  },
  {
    "id": "industrial-computers",
    "name": "Industrial Computers",
    "description": "MELIPC edge computing platforms and fanless industrial panel PCs for on-machine data processing, visualization, and Edgecross-based analytics.",
    "image": "/images/products/industrial-computers_melipc-mi5000.jpg"
  }
];
...
export const initialProducts = [
  ...
  {
    "id": "modular-io-systems-remote-io-slice",
    "name": "NZ2GN2S Series Remote I/O Slice Terminals",
    "categorySlug": "modular-io-systems",
    "summary": "Compact slice-type remote I/O terminals for CC-Link IE TSN/Field Network, enabling flexible distributed digital and analog I/O wiring on the shop floor.",
    "description": "The Mitsubishi Electric NZ2GN2S series is a slice-type remote I/O terminal supporting CC-Link IE TSN Class B/A and CC-Link IE Field Network. Millennium Control System Pune deploys these compact, DIN-rail mountable terminals to cut cabinet wiring and cable runs, distributing digital and analog I/O points close to the machine while keeping a single Ethernet backbone back to the PLC.",
    "features": [
      "Slim slice-type body with spring-clamp or screw terminal wiring options",
      "Simultaneous CC-Link IE TSN Class B/A and CC-Link IE Field compatibility",
      "Up to 32 digital I/O points per station, expandable by daisy-chaining stations",
      "IP address/station number and mode rotary switches for fast on-site commissioning",
      "Hot-swappable modules without powering down the network"
    ],
    "specifications": {
      "Network": "CC-Link IE TSN Class B/A, CC-Link IE Field Network",
      "I/O Points": "Up to 32 points per station (digital), 4/8 ch analog variants",
      "Wiring": "Spring-clamp or M3 screw terminal blocks",
      "Mounting": "DIN rail, side-by-side slice connection",
      "Power Supply": "24V DC"
    },
    "imageUrl": "/images/products/modular-io-systems_nz2-slice-terminal.jpg",
    "youtubeUrl": "https://www.youtube.com/embed/iMCk2mJAq14",
    "catalogUrl": "#"
  },
  {
    "id": "modular-io-systems-cclink-tsn-remote",
    "name": "NZ2GN12A2 Waterproof CC-Link IE TSN Remote Modules",
    "categorySlug": "modular-io-systems",
    "summary": "IP67-rated waterproof and dustproof remote I/O modules for CC-Link IE TSN, built for direct on-machine mounting in wash-down and harsh factory-floor environments.",
    "description": "The NZ2GN12A2 series extends CC-Link IE TSN connectivity directly onto the machine with an IP67 waterproof and dustproof enclosure and M12 connectors, removing the need for a control cabinet at the point of use. Millennium Control System Pune specifies these modules for conveyor lines, wash-down food & beverage equipment, and outdoor-adjacent installations where standard DIN-rail I/O cannot survive.",
    "features": [
      "IP67-rated dust and water resistant housing with M12 connectors",
      "Direct CC-Link IE TSN network connection without a cabinet enclosure",
      "Combined digital input/output stations with LED diagnostic indicators",
      "Reduces cabling runs by mounting I/O directly at the machine/sensor",
      "Withstands washdown, vibration, and outdoor-adjacent environments"
    ],
    "specifications": {
      "Protection Rating": "IP67 (dust-tight, water jet resistant)",
      "Network": "CC-Link IE TSN Class B",
      "Connector Type": "M12 circular connectors",
      "I/O Points": "16 combined digital I/O points per module",
      "Mounting": "Direct on-machine mounting, no cabinet required"
    },
    "imageUrl": "/images/products/modular-io-systems_nz2-waterproof-remote.jpg",
    "youtubeUrl": "https://www.youtube.com/embed/iMCk2mJAq14",
    "catalogUrl": "#"
  },
  {
    "id": "industrial-computers-melipc",
    "name": "MELIPC MI5000 Series Edge Computing Devices",
    "categorySlug": "industrial-computers",
    "summary": "Dual-OS (VxWorks + Windows) rack-mount edge computers that combine real-time device control with on-machine data processing and Edgecross analytics.",
    "description": "The Mitsubishi Electric MELIPC MI5122-VW runs VxWorks for deterministic device control alongside Windows for data visualization and analysis on a single module. Millennium Control System Pune integrates MI5000 series edge computers to collect production data over CC-Link IE Field Network at 1ms cycles, run Edgecross Basic Software Data Collector, and feed dashboards without needing a separate PC and PLC.",
    "features": [
      "Dual-OS architecture: VxWorks real-time control + Windows analytics in one module",
      "1ms cyclic CC-Link IE Field Network communication for control and data",
      "Edgecross Basic Software Data Collector pre-installed",
      "Windows can restart independently without interrupting VxWorks control",
      "Reduces panel footprint by replacing a separate PC + controller pairing"
    ],
    "specifications": {
      "Operating Systems": "VxWorks (real-time) + Windows 10 IoT Enterprise",
      "Network": "CC-Link IE Field Network (1ms cycle)",
      "Mounting": "Base-unit rack mount, MELSEC iQ-R compatible slot",
      "Software": "Edgecross Basic Software Data Collector, MI Configurator",
      "Storage": "SSD storage with data logging capability"
    },
    "imageUrl": "/images/products/industrial-computers_melipc-mi5000.jpg",
    "youtubeUrl": "https://www.youtube.com/embed/iMCk2mJAq14",
    "catalogUrl": "#"
  },
  {
    "id": "industrial-computers-fanless-ipc",
    "name": "MELIPC MI3000 Series Fanless Panel Computers",
    "categorySlug": "industrial-computers",
    "summary": "Fanless, high-reliability 21.5-inch touchscreen industrial panel PCs pre-loaded with Edgecross, SLMP data collection, and GT SoftGOT2000 HMI runtime.",
    "description": "The Mitsubishi Electric MELIPC MI3000 series (MI3321G-W / MI3315G-W) is a fanless industrial panel computer with a full-HD widescreen touch display, Intel Core processor, and pre-installed Edgecross Basic Software, SLMP Data Collector, and GT SoftGOT2000. Millennium Control System Pune deploys these for line-side HMI, SCADA visualization, and production monitoring where a standard IPC's fan and moving parts would be a reliability risk.",
    "features": [
      "Fanless, sealed diecast design for long service life in dusty/vibration environments",
      "21.5-inch full-HD widescreen projected-capacitive touch display",
      "Intel Core i3 processor, 8GB memory, 64GB SSD storage",
      "Pre-installed Edgecross Basic Software, SLMP Data Collector, GT SoftGOT2000",
      "Multiple Ethernet, USB, and serial ports for direct PLC/HMI connectivity"
    ],
    "specifications": {
      "Display": "21.5-inch Full HD (1920x1080) projected-capacitive touch",
      "Processor": "Intel Core i3, 8GB RAM / 64GB SSD",
      "Cooling": "Fanless sealed diecast enclosure",
      "Pre-installed Software": "Edgecross Basic Software, SLMP Data Collector, GT SoftGOT2000",
      "Interfaces": "Ethernet, USB, RS-232/485, HDMI/DisplayPort"
    },
    "imageUrl": "/images/products/industrial-computers_melipc-mi3000-fanless.jpg",
    "youtubeUrl": "https://www.youtube.com/embed/iMCk2mJAq14",
    "catalogUrl": "#"
  }
];
